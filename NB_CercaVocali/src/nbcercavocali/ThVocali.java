...
public class ThVocali extends Thread {
    ...
    private final Semaphore semFinito;
     ...
     */
    public ThVocali(char vocale, boolean delay, boolean yield, String frase, DatiCondivisi dati, Semaphore semFinito) {
        this.vocale = vocale;
        this.delay = delay;
        this.yield = yield;
        this.frase = frase;
        this.ptrDati = dati;
        this.semFinito = semFinito;
    }
