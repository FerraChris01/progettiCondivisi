...
public class NBDinDonDan {
    ...
    public static void main(String[] args) {
        ...
        Semaphore dinDan = new Semaphore(1);
        Semaphore donDin = new Semaphore(0);
        Semaphore danDon = new Semaphore(0);

        ThSuono th1 = new ThSuono("DIN", 3, dati, semFinito, dinDan, donDin);
        ThSuono th2 = new ThSuono("DON", 3, dati, semFinito, donDin, danDon);
        ThSuono th3 = new ThSuono("DAN", 3, dati, semFinito, danDon, dinDan);
        try {
            th1.start();
            th2.start();
            th3.start();
