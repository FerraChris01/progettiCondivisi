...
public class NB_CorsaCavalli {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Semaphore semFinito = new Semaphore(-4);

            DatiCondivisi dati = new DatiCondivisi();
            ThCorsa Clop1 = new ThCorsa(1, true, true, dati, semFinito);
            ThCorsa Clop2 = new ThCorsa(2, true, true, dati, semFinito);
            ThCorsa Clop3 = new ThCorsa(3, true, true, dati, semFinito);
            ThCorsa Clop4 = new ThCorsa(4, true, true, dati, semFinito);
            ThCorsa Clop5 = new ThCorsa(5, true, true, dati, semFinito);
            ...
            while (!dati.getContinua()) {
                try {
                    dati.visualizzaLinee();
                    String s = console.readLine();
                    if (s.endsWith(" ")) {
                        dati.setContinua(true);
                    } else {
                        clearConsole();
                    }
